...
class MedicineBillForm extends StatefulWidget {
  @override
  _MedicineBillFormState createState() => _MedicineBillFormState();
}
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      _nameController.text =
          _MedicineBillFormState.friendsList[widget.index] ?? '';
    });
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onChanged: (v) => _MedicineBillFormState.friendsList[widget.index] = v,
    ...
    return Container(
        child: Padding(
            ...
            child: TextFormField(
              ...
              onChanged: (v) =>
                  _MedicineBillFormState.friendsList[widget.index] = v,
